  ...
  $.fn.quovolver = function(options) {
    ...
    return this.each(function () {
      ...
      function buildNav() {
        ...
        if ( o.navPrev ) {
          nav.append('<span class="nav-prev"><a href="#"><img src="img/arrow_prv.png" alt="back slide" /></a></span>');
        }
        if ( o.navNext ) {
          nav.append('<span class="nav-next"><a href="#"><img src="img/arrow_next.png" alt="back slide" /></a></span>');
        }
        // Numbered navigation
        if ( o.navNum ) {
